...
// node_modules/grade-js/src/index.js
var require_src = __commonJS({
  "node_modules/grade-js/src/index.js"(exports, module) {
    var prefixes = ["webkit"];
    var Grade = class {
      ...
      getSortedValues(uniq) {
        const occurs = Object.keys(uniq).map((key) => {
          const rgbaKey = key;
          let components = key.split("|"), brightness = (components[0] * 299 + components[1] * 587 + components[2] * 114) / 1e3;
          return {
            rgba: rgbaKey.split("|"),
            occurs: uniq[key],
            brightness
      ...
      getTextProperty(top) {
        ...
        let o = Math.round((parseInt(rgb[0]) * 299 + parseInt(rgb[1]) * 587 + parseInt(rgb[2]) * 114) / 1e3);
        if (o > 125) {
          return "color: #000";
        } else {
          return "color: #fff";
    ...
    module.exports = (containers, img_selector, callback) => {
      const init = (container, img_selector2, callback2) => {
        let grade = new Grade(container, img_selector2, callback2), gradientData = grade.gradientData;
...
//# sourceMappingURL=grade-js.js.map
