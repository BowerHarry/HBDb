...
function useList(params) {
  ...
  const handleHighlightChange = React9.useCallback((event, value, reason) => {
  ...
  const stateComparers = React9.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React9.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React9.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React9.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React9.useRef([]);
  React9.useEffect(() => {
  ...
  const getItemState = React9.useCallback((item) => {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React15.useContext(DropdownContext);
  if (menuContext === null) {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React16.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useSnackbar(parameters = {}) {
  ...
  const handleResume = React24.useCallback(() => {
...
function useTabs(parameters) {
  ...
  const onSelected = React26.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React26.useRef(() => void 0);
  const getTabPanelId = React26.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React26.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React26.useCallback((lookupFunction) => {
...
var Tabs = React29.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React31.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React31.useCallback((tabValue) => {
  ...
  const handleChange = React31.useCallback((event, newValue) => {
    var _newValue$;
  ...
  const isItemDisabled = React31.useCallback((item) => {
  ...
  const contextValue = React31.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useTab(parameters) {
  ...
  const tabMetadata = React33.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var TextareaAutosize = React34.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime10.jsxs)(React34.Fragment, {
...
var Button = React36.forwardRef(function Button2(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3J25LE4E.js.map
